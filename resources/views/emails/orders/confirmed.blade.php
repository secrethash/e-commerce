                                    ...
                                    <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                        <tr>
                                            <td class="pull-left mobile-header-padding-left"
                                                ...
                                                <a href="{{route('home')}}">
                                                    <img width="137"
                                                        src="{{asset('images/logo-prop.png')}}"
                                                        alt="logo" />
                                                </a>
                                            </td>
                                            <td class="pull-right mobile-header-padding-right" style="color: #4d4d4d;">
                                                @if(!blank(shopper_setting('shop_twitter_link')))
                                                    <a href="{{shopper_setting('shop_twitter_link')}}">
                                                        <img width="30" height="30"
                                                            src="https://img.icons8.com/ios/50/null/twitter--v1.png"
                                                            alt="twitter" />
                                                    </a>
                                                @endif
                                                @if(!blank(shopper_setting('shop_facebook_link')))
                                                    <a href="{{shopper_setting('shop_facebook_link')}}">
                                                        <img width="30" height="30"
                                                            src="https://img.icons8.com/ios/50/null/facebook-new.png"
                                                            alt="facebook" />
                                                    </a>
                                                @endif
                                                @if(!blank(shopper_setting('shop_instagram_link')))
                                                    <a href="{{shopper_setting('shop_instagram_link')}}">
                                                        <img width="30" height="30"
            ...
            <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        <tr>
                            <td class="free-text">
                                We wanted to let you know that your order <a href="{{route('user.orders.view', $order->number)}}">#{{$order->number}}</a> has been Confirmed.
              ...
              <![endif]-->
                                    <a href="{{route('user.orders.view', $order->number)}}"
                                        style="background-color:#ea1b25;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">
                                        View Order
                                    </a>
                                </div>
                            </td>
                                                            ...
                                                            <tr>
                                                                <td class="mini-block">
                                                                    ...
                                                                    @if($order->shippingAddress->street_address_plus)
                                                                        {{$order->shippingAddress->street_address_plus}} <br />
                                                                    @endif
                                                                    {{$order->shippingAddress->city}} - {{$order->shippingAddress->zipcode}} <br />
                                                                    {{$order->shippingAddress->country->flag}} {{$order->shippingAddress->country->name}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td class="mini-block">
                                                                    ...
                                                                    {{$order->created_at->format('D, d M Y')}} <br />
                                                                    <br />
                                        ...
                                        <tr>
                                            <td class="item-col item">
                                                <table cellspacing="0" cellpadding="0" width="100%">
                                                    <tr>
                                                        <td class="mobile-hide-img">
                                                            <img width="110" height="auto"
                                                                src="{{product_images($item->product)->thumb}}"
                                                                alt="{{$item->product->name}}" style="max-height: 100px;">
                                                        </td>
                                                        <td class="product">
                                                            <span style="color: #4d4d4d; font-weight:bold;">
                                                                {{str($item->product->name)->words(3)}}
                                                            </span> <br />
                                                            {{$item->product->sku}}
                                                        </td>
                                                    </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        <tr>
                            <td style="padding: 25px 0 25px">
                                <a href="{{route('home')}}"><img width="137"
                                    src="{{asset('images/logo-square.png')}}"
                                    alt="logo"></a><br />
                                <strong>{{ shopper_setting('shop_legal_name') }}</strong><br />
                                {{ Shopper\Framework\Models\System\Country::find(shopper_setting('shop_country_id'))->flag }} {{ shopper_setting('shop_street_address') }}<br />
                                {{ shopper_setting('shop_city') }} - {{ shopper_setting('shop_zip_code') }} <br />
                                {{ Shopper\Framework\Models\System\Country::find(shopper_setting('shop_country_id'))->name }} <br /><br />
                            </td>
                        </tr>
                    </table>
                </center>
